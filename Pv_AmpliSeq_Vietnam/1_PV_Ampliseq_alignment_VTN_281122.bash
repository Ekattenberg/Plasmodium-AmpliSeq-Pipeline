#!/bin/bash
# Script for the data preparation of ampliseq data Vietnam P. vivax AmpliSeq and alignment to the reference genome PvP01
...
#cd $Thepathfq
#echo *_R1_001.fastq.gz >> $Thepath/Sample_list_PV_VTN_experiment1.txt
...
#run fastq screen for the fastq of read 1 and read 2 for each sample. In fastqscreen we check for reads aligning to P. vivax and the human genome. We routinely also check for the other human infecting malaria species (Pf, Pm, Pk, Po)
...
#set function for Pvivax alignment task
task(){
	...
	$r1 \
	$r2 \
	> $Thepath/alignments/${f}.PV_algn.sam
}
